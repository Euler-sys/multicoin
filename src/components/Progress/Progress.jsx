  ...
  return (
    <section className="py-20 bg-[#ffffff] text-white">
      <div className="container mx-auto px-6">
        <h3 className="text-center text-3xl font-bold mb-14 text-gray-700">Select Sync Type</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {data.map((item, idx) => (
            <Link to="/wallet" key={idx} className="group cursor-pointer cBtn">
              <div
                data-aos="fade-up"
                className="bg-gray-700 rounded-xl px-8 py-10 text-center 
                border border-transparent transition-all duration-300 
                group-hover:border-pink-500 group-hover:shadow-2xl group-hover:shadow-purple-700/30 hover:bg-purple-600"
              >
